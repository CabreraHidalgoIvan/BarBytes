...
@Component({
  selector: 'app-list-camarero-pedidos2',
  templateUrl: './list-camarero-pedidos2.component.html',
  styleUrls: ['./list-camarero-pedidos2.component.scss']
})
export class ListCamareroPedidos2Component {
