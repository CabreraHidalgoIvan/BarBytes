...
@Component({
  selector: 'app-list-camarero-pedidos',
  templateUrl: './list-camarero-pedidos.component.html',
  styleUrls: ['./list-camarero-pedidos.component.scss']
})
export class ListCamareroPedidosComponent {
