...
@Component({
  selector: 'app-list-camarero-pedidos3',
  templateUrl: './list-camarero-pedidos3.component.html',
  styleUrls: ['./list-camarero-pedidos3.component.scss']
})
export class ListCamareroPedidos3Component {
